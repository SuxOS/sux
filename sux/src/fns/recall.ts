...
export const recall: Fn = {
	...
	descShort:
		"Personal cross-store recall: 'what do I know about X?' fanned out across vault/files/mail/imessage/calendar/contacts/web/learned/oracle into one cited, read-only answer.",
	inputSchema: {
		type: "object",
