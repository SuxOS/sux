...
export type WatchChange = { url: string; selector?: string; label?: string; hash: string; previous_hash?: string; numeric_value?: number; previous_numeric_value?: number; checked_at: string };
...
export type WatchCheckResult = { changed: boolean; first_seen: boolean; hash: string; previous_hash?: string; numeric_value?: number; previous_numeric_value?: number };
