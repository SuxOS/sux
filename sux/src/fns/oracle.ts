...
export const oracle: Fn = {
	...
	descShort:
		"Learn-then-answer knowledge oracle: teach text/a URL, distilled per topic; ask a cited question over everything indexed. Actions: get/list/status/forget/ask/feedback/reindex.",
	inputSchema: {
		type: "object",
