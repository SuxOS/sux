...
export const ingest: Fn = {
	...
	descShort:
		"Universal capture inbox: save a url/text/query as a vault note (git-backed), distilled+indexed for oracle recall. PDFs land as blobs (use `study` for text); `portal` captures gated sources.",
	inputSchema: {
		type: "object",
