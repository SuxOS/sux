...
describe("agenda — detectors", () => {
	...
	it("wires the cross-semantic sweep's ready batch in as an fyi drop (#948), pointing at vault_cross_link_plan", () => {
	...
	it("no cross-semantic drops when there's nothing to report", () => {
		...
		expect(detectCrossSemanticDrops({ week: "2026-W28", candidate_count: 0, candidates: [] })).toHaveLength(0);
	});
