...
// EMPTY; until it's populated it answers nothing. This module reads the existing corpus — the
// KV cosine cores (vault/mail/files/contacts) and the `_source` chunk store (oracle/assim/phi/
// advise) — and turns each domain into a stably-ordered, namespace-tagged `IndexUnit[]`
