...
// collide with internal cache:/sux:/oauth keys — the "kv:" prefix already confines
// every key this fn can touch, so there's no reserved-space collision to guard
// against beyond that. A key is rejected if, after trimming, it is empty.
const NS = "kv:";
