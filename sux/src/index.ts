...
// can run close to FN_DEADLINE_MS today; advise/life_wiki fan out recall's own
// multi-source gather (vault/mail/files, and life_wiki further across learned)
// synchronously with no async fallback. Everything else stays request/response
...
const TASK_CAPABLE_TOOLS = new Set(["pipe", "batch", "render", "crawl", "batch_fetch", "shop", "advise", "life_wiki"]);
